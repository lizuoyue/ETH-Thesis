...
As a result, VGG-16 is used only once and therefore it can speed up the prediction in theory. Note that this version of \modelnameshort is not implemented yet in 
since the resolution problem of the area image.
